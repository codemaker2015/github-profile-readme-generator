...
const Header = (props) => {
  ...
  const fetchData = async () => {
    if (shouldRequestStats()) {
      const response = await axios.get('https://api.github.com/repos/codemaker2015/github-profile-readme-generator');
  ...
  return (
    <div className="shadow flex items-center justify-center flex-col mb-2 py-2">
      ...
      <div className="flex justify-center items-center">
        <a href="https://github.com/codemaker2015/github-profile-readme-generator" aria-label="Star codemaker2015/github-profile-readme-generator on GitHub" target="blank" className="mr-2">
        ...
        <a href="https://github.com/codemaker2015/github-profile-readme-generator/fork" aria-label="Fork codemaker2015/github-profile-readme-generator on GitHub" target="blank">
          <div className="text-xxs sm:text-sm border-2 border-solid border-gray-900 bg-gray-100 flex items-center justify-center py-1 px-2">
